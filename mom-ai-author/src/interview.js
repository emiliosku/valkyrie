...
function validateGenerated(generated) { try { return validateQuest(generated && generated.files); } catch (error) { return { errors: [error.message], warnings: [] }; } }
